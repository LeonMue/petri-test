...
public class Older {
    ...
    public static Older deserialize(byte[] serialized) throws org.dhbw.ka.ml.petrilib.serializing.ParseException {
        final Older yyResultValue = new Older();
    ...
    static Older yyDeserialize(org.dhbw.ka.ml.petrilib.io.PetriReader petriReader, int length) throws IOException {
        final Older yyResultValue = new Older();
