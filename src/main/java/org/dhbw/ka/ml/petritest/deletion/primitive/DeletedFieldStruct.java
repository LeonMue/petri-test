...
public class DeletedFieldStruct {
    ...
    public static DeletedFieldStruct deserialize(byte[] serialized) throws org.dhbw.ka.ml.petrilib.serializing.ParseException {
    ...
    static DeletedFieldStruct yyDeserialize(org.dhbw.ka.ml.petrilib.io.PetriReader petriReader, int length) throws IOException {
        final DeletedFieldStruct yyResultValue = new DeletedFieldStruct();
