...
public class Empty {
    ...
    public static Empty deserialize(byte[] serialized) throws org.dhbw.ka.ml.petrilib.serializing.ParseException {
        final Empty yyResultValue = new Empty();
    ...
    static Empty yyDeserialize(org.dhbw.ka.ml.petrilib.io.PetriReader petriReader, int length) throws IOException {
        final Empty yyResultValue = new Empty();
